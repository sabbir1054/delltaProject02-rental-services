          ...
          <Row className="w-100 gx-0">
            <Col md={6} className={`${styles.col_left} `}>
              ...
              <div className="teacher-img d-flex justify-content-center">
                <img src="https://i.ibb.co/vQ3LXPm/teacher.png" alt="" className='img-fluid'/>
              </div>
              <div className="teacher_bottom text-center">
                <div
                  className={`${styles.sign_up_teacher} bg-white d-inline-block rounded`}
                >
            ...
            <Col md={6} className={`${styles.col_right}`}>
              ...
              <div className="student-img d-flex justify-content-center">
                <img src="https://i.ibb.co/NjR78yf/student-Pick.png" alt="" className='img-fluid'/>
              </div>
              <div className="teacher_bottom text-center">
                <div
                  className={`${styles.sign_up_student} bg-white d-inline-block rounded`}
                >
